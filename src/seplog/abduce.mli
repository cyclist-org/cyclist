(** This module contains functions to answer various abduction questions for use
...
(** [abd_substs f f'] returns an option result that consists of a pair of
    ...
    - for all substitutions [theta] in [substs], [theta] applied to [g'] is a
      subformula of [g], and if the optional argument [allow_frame=true] is set
      to false, then also the spatial parts are equal. *)
