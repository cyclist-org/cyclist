...
let gen_print () =
  if !do_statistics then
      ...
      Printf.printf
        ...
        (if Pervasives.(=) !Gen.cpu_time 0. then 0. else (100.0 *. !MC.cpu_time /. !Gen.cpu_time)) ;
      Printf.printf
      ...
      Printf.printf
        ...
        (if Pervasives.(=) !Gen.cpu_time 0. then 0. else (100.0 *. !CC.cpu_time /. !Gen.cpu_time)) ;
      Printf.printf
      ...
      Printf.printf
        ...
        (if Pervasives.(=) !Gen.cpu_time 0. then 0. else (100.0 *. !Invalidity.cpu_time /. !Gen.cpu_time)) ;
      Printf.printf
