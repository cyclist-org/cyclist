...
private:
    ...
    void traverse_cycles_subset_from(int cycle_idx, Vec<int> &visited_idxs, Vec_shared_ptr<int> cycles_subset, Vec_shared_ptr<Int_pair> structural_connectivity_relation)
    {
