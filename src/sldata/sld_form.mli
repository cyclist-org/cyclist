...
include Util.BasicType with type t = Sld_heap.t list
...
(** Do all disjuncts entail false in the sense of [Sld_heap.inconsistent]? *)
...
(** Like [Sld_heap.subst_existentials] applied to all disjuncts. *)

val subst_tags : Util.TagPairs.t -> t -> t
(** Like [Sld_heap.subst_tags] applied to all disjuncts. *)
