...
Claims we have made in the paper about the database, and the coverage and performance of the various incomplete methods, can be verified by examining the data in the `stats.csv` file, generated by the `graph_stats.sh` script described in the [section above](#graph_statssh).
