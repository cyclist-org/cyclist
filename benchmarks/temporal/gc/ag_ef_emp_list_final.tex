\begin{prooftree}
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
    \vdash 10 : \mathit{x}:=\mathit{y};7 : \mbox{\ldots } : \diamond EF
  \begin{gathered}emp\end{gathered}
  \using(\mbox{Assign})
  \]
  \justifies
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x} 
  \end{gathered}
  \vdash 9 : \mathit{y}.\mbox{\texttt{next}}:=\mathit{x};10 : \mbox{\ldots } : \diamond EF
  \begin{gathered}emp\end{gathered}
  \using(\mbox{Assign})
  \]
  \justifies
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 9 : \mathit{x}.\mbox{\texttt{next}}:=\mathit{x};10 : \mbox{\ldots } : EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{UnfoldEF})
  \]
  \justifies
  ...
  \begin{gathered}
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 8 : \mathit{y}:= \texttt{new()};9 : \mbox{\ldots } : \diamond EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{New})
  \]
  \justifies
  ...
  \begin{gathered}
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 8 : \mathit{y}:= \texttt{new()};9 : \mbox{\ldots } : EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{UnfoldEF})
  \]
  \[
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 10 : \mathit{x}:=\mathit{y};7 : \mbox{\ldots } : \Box AG EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{Assign})
  \]
  \justifies
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 10 : \mathit{x}:=\mathit{y};7 : \mbox{\ldots } : AG EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{UnfoldAG})
  \]
  \justifies
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 9 : \mathit{y}.\mbox{\texttt{next}}:=\mathit{x};10 : \mbox{\ldots } : \Box AG EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{Assign})
  \]
  \justifies
  ...
  \begin{gathered}
    ...
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered} 
  \vdash 9 : \mathit{y}.\mbox{\texttt{next}}:=\mathit{x};10 : \mbox{\ldots } : AG EF 
  \begin{gathered}emp\end{gathered}
    \using(\mbox{UnfoldAG})
  \]
  \justifies
  ...
  \begin{gathered}
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 8 : \mathit{y}:= \texttt{new()};9 : \mbox{\ldots }\mbox{\texttt{od}} : \Box AG EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{New})
  \]
  \justifies
  ...
  \begin{gathered}
    \mathit{\mbox{\texttt{nil}}} = \mathit{x}
  \end{gathered}
  \vdash 8 : \mathit{y}:= \texttt{new()};9 : \mbox{\ldots }\mbox{\texttt{od}} : AG EF 
  \begin{gathered}emp\end{gathered}
  \using(\mbox{UnfoldAG})
  \]
  \justifies
  ...
  \begin{gathered}
    {\mathit{ls}}_{1}(\mathit{x}, \mathit{\mbox{\texttt{nil}}})
  \end{gathered}
    \vdash 7 : \mbox{\texttt{while}}\;*\;\mbox{\texttt{do}}\;8 : \mbox{\ldots }\mbox{\texttt{od}} : \diamond EF  
  \begin{gathered}emp\end{gathered}
  \using(\mbox{While-<>2})
  \]
  \justifies
